...
public class SellerShopViewModel {
    ...
    public final ObservableArrayList<SellerGoodsViewModel> goods = new ObservableArrayList<>();

    public SellerShopViewModel(){
    ...
    public void setSellerShopViewModel(ShopModel shopModel){
        this.no.set(shopModel.getNo());
        this.location.set(shopModel.getLocation());
        this.shop.set(shopModel.getShop());
        for(int i =0; i<shopModel.getGoods().size() ;i++){
            goods.add(new SellerGoodsViewModel(shopModel.getGoods().get(i).getName(), shopModel.getGoods().get(i).getPrice(),
                    shopModel.getGoods().get(i).getQuantity(),shopModel.getGoods().get(i).getCategory(),shopModel.getGoods().get(i).getImage()));
        }
    }
